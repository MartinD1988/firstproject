========================================================================
    KONSOLENANWENDUNG: zeichenbegrenzen-Projektübersicht
========================================================================

Diese zeichenbegrenzen-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre zeichenbegrenzen-Anwendung besteht.


zeichenbegrenzen.vcxproj
...
zeichenbegrenzen.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen zeichenbegrenzen.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
