========================================================================
    KONSOLENANWENDUNG: Gerichtsperspektive-Projektübersicht
========================================================================

Diese Gerichtsperspektive-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Gerichtsperspektive-Anwendung besteht.


Gerichtsperspektive.vcxproj
...
Gerichtsperspektive.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Gerichtsperspektive.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
