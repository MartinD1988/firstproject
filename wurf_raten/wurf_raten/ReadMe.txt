========================================================================
    KONSOLENANWENDUNG: wurf_raten-Projektübersicht
========================================================================

Diese wurf_raten-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre wurf_raten-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen wurf_raten.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
